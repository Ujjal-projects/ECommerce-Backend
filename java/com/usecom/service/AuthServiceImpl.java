...
//		username = username.substring(SINGING_PREFIX.length);
		String SELLER_PRIFIX = "seller_";
		
		if(username.startsWith(SELLER_PRIFIX)) {
			username = username.substring(SELLER_PRIFIX.length());
		}
